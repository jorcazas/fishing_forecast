...
componen principalmente de embarcaciones menores de pesca ribereña \citep{cnp2025}. Su
producción abarca decenas de especies entre pesca y acuacultura, donde sobresalen la sardina,
...
21 series de langosta y de $\sim$5 a $\sim$9 temporadas) y aumentando la capacidad del modelo
...
\begin{itemize}
  ...
  \item Un \textbf{modelo global} sobre las series del conjunto consolidado (de 28 a 33
  con datos suficientes, según el corte) con la variable objetivo en escala logarítmica, que
  supera o empata a los modelos específicos en cuatro de cinco series.
