...
resultante. La descripción variable por variable del acervo original de la primera iteración está en el Apéndice~\ref{ap:variables}; las variables vigentes se describen en las Secciones~\ref{sec:datos_fuentes} y~\ref{sec:datos_features}.
...
---0.05\textdegree{} para la SST y 4~km para el color del océano--- el rectángulo es una
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.72\linewidth]{fig_zona_sq.png}
\caption{Detalle de la zona costera (\emph{bounding box}) asignada a la \ue{} LITORAL DE BAJA
CALIFORNIA S DE PR DE RL, la cooperativa de San Quintín que sirve de serie insignia, sobre la
SST media. El rectángulo cubre también tierra; los píxeles sobre tierra no tienen dato de SST y
no entran al promedio espacial.}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\linewidth]{fig_desplazamiento.png}
\caption{El desplazamiento temporal de 90 días con la SST real de la zona de San Quintín
(2019-2020): en azul la serie original y en amarillo la desplazada. La convención del proyecto
usa el estado del océano en $t$ para predecir la captura en $t+90$ días.}
