El conjunto de datos utilizado está compuesto de fecha 'ds', variable objetivo 'y' y 16 variables regresoras 'xi', como se muestra en la Tabla~\ref{tab:datos}.
\begin{table}[htbp]
\centering
...
\begin{itemize}
    \item \textbf{Variable ds | Fecha:} El conjunto de datos cuenta con observaciones diarias desde el 01 de enero de 2017 hasta el 31 de diciembre de 2021. La fecha tiene el formato d-m-y
...
En el documento de GlobColour \citep{globcolour2020} se proporciona información detallada sobre el procesamiento de cada variable.
