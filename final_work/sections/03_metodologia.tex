...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\linewidth]{fig_splits.png}
...
($z$-score con media y desviación calculadas solo en entrenamiento), que resulta inferior al logaritmo en las series clave.
...
(\texttt{157} pruebas unitarias que cubren el proceso de datos, las métricas, la construcción
...
\begin{itemize}
  ...
  resumen en Markdown, de modo que las cifras de este documento provienen de esos artefactos versionados o, en el caso de las instantáneas históricas señaladas como tales, de la bitácora de corridas del repositorio;
