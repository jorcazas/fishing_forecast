...
año siguiente; fuera de ese rango rige la veda. Se define el indicador $\mathrm{ens}_s(t) \in
...
series de tiempo filtra el futuro hacia el pasado.
...
\UEs{}, se agrega el sMAPE, acotado en $[0, 200]$ y definido con la convención de que los
...
ARIMA y Prophet \citep{taylor2017} sirven de piso: son autorregresivos y no usan covariables
...
La LSTM \citep{greff2017,staudemeyer2019} procesa la serie como secuencia. Se usa una ventana
...
El trabajo se implementó como un paquete de Python con pruebas automatizadas
