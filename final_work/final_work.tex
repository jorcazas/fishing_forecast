...
\begin{tabular}{lcc}
\toprule
Cobertura del intervalo 90\% & Corte 2020-07-01 & Corte 2024-06-01 \\
 & (bache fuera del train) & (bache en el train) \\
\midrule
Langosta @ San Quintín, con 7 series & 40.6\% & 95.8\% \\
Langosta @ San Quintín, con 10 series & 99.8\% & \textbf{96.2\%} \\
Cobertura marginal (10 series) & 97.9\% & 96.7\% \\
CRPS global (10 series) & 114.8 & 130.8 \\
\bottomrule
\end{tabular}
\caption{Estabilidad de la calibración de la langosta de San Quintín según el corte de prueba y la composición del pool. Con el bache \emph{fuera} del entrenamiento (corte 2020) la cobertura por serie oscila entre 40.6\% y 99.8\% según cuántas series haya en el pool ---no es fiable en ninguna dirección---; con el bache \emph{dentro} (corte 2024) es estable en torno al 96\% independientemente del pool. El CRPS es mayor en el corte de 2024 porque su conjunto de prueba concentra las temporadas recientes de baja captura, intrínsecamente más difíciles.}
