...
En segundo lugar, los experimentos con modelos multivariados y con un modelo global multi-especie confirman que el factor limitante sigue siendo la cantidad de temporadas y de series disponibles, no la sofisticación del modelo. La evidencia de transferencia positiva dentro de una misma especie entre unidades económicas es alentadora y señala el camino a seguir: un enfoque jerárquico (\emph{partial pooling}) que comparta información entre zonas y especies sin dejar que las series de mayor volumen dominen el ajuste. Escalar a más unidades económicas y acumular más temporadas —junto con el índice de MHW como covariable estándar— constituye la ruta más prometedora hacia un modelo operativo y transferible.
