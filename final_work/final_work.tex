...
Primero, se incorporó un clúster de cinco cooperativas de langosta de la región de El Rosario ($\sim$29.6--30.4$^\circ$N), llevando la langosta de 2 a 7 series (especie, unidad económica). El efecto sobre la serie insignia es inmediato: con el corte canónico de 01-julio-2020, el RMSE del \emph{pooling} de langosta en San Quintín cae de 659 a 313 kg, la cobertura marginal del intervalo del 90\% sube del 86\% al 93\%, y el ancho del percentil 90 de los días pico se estrecha de $\sim$9\,776 a $\sim$3\,812 kg. Es transferencia positiva dentro de la especie, ahora con siete zonas en lugar de dos.

Segundo, y de mayor impacto, se desbloquearon las temporadas 2022-2026 mediante la unión con los avisos de cosecha de CONAPESCA (Sección~\ref{sec:extension2026}). Esto permite mover el corte de prueba a 01-junio-2024, dejando el bache post-MHW de 2021-2022 y su recuperación \emph{dentro} del conjunto de entrenamiento y calibración, en lugar de en la prueba. El resultado resuelve la sub-cobertura de la langosta de San Quintín que ningún ajuste de modelo había logrado tocar (Tabla \ref{tab:extension_moredata}): la cobertura del intervalo del 90\% para esa serie salta del 40.6\% al 95.8\%, y el intervalo, antes demasiado estrecho por haberse calibrado con una sola temporada previa al crash, ensancha su mediana de 21 a 471 kg ---el precio honesto de cubrir un régimen que antes quedaba fuera de la distribución aprendida.

\begin{table}[H]
\centering
\begin{tabular}{lcc}
\toprule
Métrica (intervalo nominal 90\%) & Corte 2020-07-01 & Corte 2024-06-01 \\
\midrule
Cobertura langosta @ San Quintín & 40.6\% & \textbf{95.8\%} \\
Cobertura marginal (todas las series) & 94.0\% & 95.0\% \\
Cobertura en días de MHW & 94.1\% & 90.2\% \\
Ancho mediano langosta @ San Quintín (kg) & 21.0 & 471.2 \\
CRPS global & 158.1 & 220.6 \\
\bottomrule
\end{tabular}
\caption{Efecto de mover el corte de prueba para incluir las temporadas 2022-2026 (union COBI+CONAPESCA) en el entrenamiento y la calibración. La langosta de San Quintín pasa de sub-cubrir gravemente a quedar bien calibrada; la cobertura durante olas de calor se mantiene cerca del nominal. El CRPS global aumenta porque el conjunto de prueba de 2024 concentra las temporadas de recuperación, intrínsecamente más difíciles.}
\label{tab:extension_moredata}
\end{table}

La conclusión es la que se venía anticipando, ahora con evidencia experimental directa: la palanca decisiva fue añadir temporadas, no endurecer los estimadores. La poda por SHAP y la optimización bayesiana de los cuantílicos no habían movido la sub-cobertura de la langosta de San Quintín; una sola temporada adicional de calibración ---la que arrastró el cambio de régimen a la distribución de entrenamiento--- la corrigió por completo.
...
Finalmente, la hipótesis que recorre todo el trabajo ---que el cuello de botella es el volumen de datos y no la sofisticación del modelo--- dejó de ser una conjetura y se puso a prueba. Al sumar cinco cooperativas de langosta de El Rosario (de 2 a 7 series) y desbloquear las temporadas 2022-2026 mediante la unión con los avisos de cosecha de CONAPESCA, la sub-cobertura crónica de la langosta de San Quintín ---que ni la selección de variables por SHAP ni la optimización bayesiana de los cuantílicos habían logrado corregir--- se resolvió: con el bache post-ola-de-calor de 2021-2022 dentro del entrenamiento, la cobertura del intervalo del 90\% pasó del 40.6\% al 95.8\%. Es la demostración más concreta de la tesis de fondo: la ruta hacia un modelo operativo y transferible pasa por acumular temporadas y unidades económicas ---junto con el índice de MHW como covariable estándar y el objetivo en escala logarítmica--- y no por más maquinaria estadística.
