...
agrupa 44 series de especie por \ue{}, con la variable objetivo en escala logarítmica, que
...
Three contributions follow. A \textbf{global model} pooling 44 species-by-cooperative series
with a log-scaled target matches or beats series-specific models in four of five series and
...
Transformer all fail to. The result is delivered as an inference application serving the
